...
contains
   ...
   subroutine pseudo2d(Amat, nx, ny, nens, rh, n1, n2)
...
! the spectral procedure outlined in Evensen (1994).
      ...
      integer, intent(in) :: nens             ! number of fields stored at the time
      real, intent(out)  :: Amat(nx, ny, nens) ! generated random fields
      real, intent(in)   :: rh              ! Horizontal decorrelation length, in nb of horizontal grid cells

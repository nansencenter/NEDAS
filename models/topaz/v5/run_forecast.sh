...
#SBATCH --job-name=topaz_fcst
#SBATCH --time=0-01:00:00
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=128
#SBATCH --qos=devel
#SBATCH --output=/cluster/home/yingyue/code/NEDAS/log/topaz_fcst.%j
...
while [[ $next_time -le $time_assim_end ]]; do
    ...
    ###prepare icbc
    $script_dir/../models/topaz/v5/module_icbc.sh &

    ###model forecast step
    $script_dir/../models/topaz/v5/module_forecast.sh &
    wait

...
def copy_group(src_group, dst_group, time_index, time_dimension_name) -> None:
    """
    ...
    for name, variable in src_group.variables.items():
        ...
        if len(variable.dimensions) == 0: continue
    ...
    for group_name in src_group.groups:
        ...
        copy_group(src_subgroup, dst_subgroup, time_index, time_dimension_name)
...
def copy_time_sliced_nc_file(source_file:str, target_file,
    ...
    with netCDF4.Dataset(source_file, 'r') as src:
        ...
        with netCDF4.Dataset(target_file, 'w') as dst:
            ...
            copy_group(src, dst, time_index, time_dimension_name)
            dst.sync()
